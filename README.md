...
This is a simple game calling number guessing game. Basic of this game is guess random number and it will repeat until guess number to be correct and this was programmed to tell about number of tries.
This programme create by using C++ language and using do while loop, srand, if, etc..
...
<h1 align="center"> NUMBER GUESSING GAME USING - C++</h1>
